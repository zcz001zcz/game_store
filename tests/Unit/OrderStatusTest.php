...
final class OrderStatusTest extends TestCase
{
    ...
    public function testPartialAndFullRefundsAreTerminal(): void
    {
        self::assertTrue(OrderStatus::Delivering->canTransitionTo(OrderStatus::PartiallyRefunded));
        self::assertTrue(OrderStatus::Delivering->canTransitionTo(OrderStatus::Refunded));
        self::assertFalse(OrderStatus::PartiallyRefunded->canTransitionTo(OrderStatus::Delivering));
        self::assertFalse(OrderStatus::Refunded->canTransitionTo(OrderStatus::Delivering));
    }
}
